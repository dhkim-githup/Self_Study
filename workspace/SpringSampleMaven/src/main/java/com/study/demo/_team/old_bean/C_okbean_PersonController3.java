...
import com.study.demo._team.old_bean.okbean_service.PersonService3;
import com.study.demo._team.old_bean.okbean_vo.PersonVo2;

@Controller
public class C_okbean_PersonController3 {
	...
	/* 생성자 위치 */
	public C_okbean_PersonController3() {
	...
	public String personList3(Model model) {
		...
		*/
		...
		return "old_bean/okbean_personlist_taglib";
	}
